  ...
  t(document).on('ready', function () {
    jQuery.fn.extend({
      equalHeights: function (e) {
        var n = this
        ;(e = t.extend({ innerItem: !1, parent: t(this).parent(), perRow: !0 }, e)),
            ...
            ;(h = e.parent.length > 1 ? t(this).find(i) : i),
              ...
              t(h).each(function () {
                ...
                if (i + r > t(u).width() && s.length > 0 && e.perRow)
                  return (
                    n.setItemsWithInner(s, a, e.innerItem, u), (s = [this]), (a = h), void (r = i)
                  )
          ...
          n = function () {
            if (r.is(':visible')) {
              var e = t.scrollLeft(),
                ...
                h = r.width(),
                u = t.width()
              i + s + f >= a && i <= a + l + f && c + h + o >= e && c <= e + u + o
...
!(function (a) {
  ...
  var n = {
    ...
    event: function () {
      ...
      if (
        (n.hasClass('navbar-sticky') && n.wrap("<div class='wrap-sticky'></div>"),
        ...
        r(t),
          ...
          s.find('ul.nav.navbar-left').wrap("<div class='col-half left'></div>"),
          s.find('ul.nav.navbar-right').wrap("<div class='col-half right'></div>"),
          s.find('ul.navbar-nav > li').each(function () {
      ...
      n.hasClass('navbar-sidebar')
        ? (a('body').addClass('wrap-nav-sidebar'), n.wrapInner("<div class='scroller'></div>"))
          ...
          a('.navbar-toggle').each(function () {
            ...
            a(this).off('click'),
              a(this).on('click', function (o) {
                return (
                  o.preventDefault(), a(n).removeClass(t), a(n).addClass('in'), a(n).addClass(e), !1
                )
              }),
