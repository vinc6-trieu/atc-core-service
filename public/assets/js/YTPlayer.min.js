  ...
  ;(jQuery.mbYTPlayer = {
    ...
    buildPlayer: function (options) {
      return this.each(function () {
        ...
        ;(YTPlayer.loop = 0),
          ...
          jQueryYTPlayer.addClass('mb_YTPlayer')
        var property =
          jQueryYTPlayer.data('property') && 'string' == typeof jQueryYTPlayer.data('property')
            ? eval('(' + jQueryYTPlayer.data('property') + ')')
            : jQueryYTPlayer.data('property')
        'undefined' != typeof property &&
          'undefined' != typeof property.vol &&
          (property.vol = 0 === property.vol ? (property.vol = 1) : property.vol),
        ...
        ;(YTPlayer.canGoFullScreen = !(jQuery.browser.msie || jQuery.browser.opera || isIframe())),
          ...
          jQueryYTPlayer.attr('id') || jQueryYTPlayer.attr('id', 'video_' + new Date().getTime())
        var playerID = 'mbYTP_' + YTPlayer.id
        ;(YTPlayer.isAlone = !1), (YTPlayer.hasFocus = !0)
        var videoID = this.opt.videoURL
            ? getYTPVideoID(this.opt.videoURL).videoID
            : jQueryYTPlayer.attr('href')
              ? getYTPVideoID(jQueryYTPlayer.attr('href')).videoID
              : !1,
          playlistID = this.opt.videoURL
            ? getYTPVideoID(this.opt.videoURL).playlistID
            : jQueryYTPlayer.attr('href')
              ? getYTPVideoID(jQueryYTPlayer.attr('href')).playlistID
              : !1
        ...
        if (
          ...
          (YTPlayer.defaultOpt.containment = YTPlayer.opt.containment =
            jQuery('self' == YTPlayer.opt.containment ? this : YTPlayer.opt.containment)),
          ...
          if (
            ...
            isPlayer ? (YTPlayer.isPlayer = !0) : jQueryYTPlayer.hide(),
            jQuery.browser.mobile && !YTPlayer.canPlayOnMobile)
          )
            return void jQueryYTPlayer.remove()
                    ...
                    events: {
                      onReady: function (a) {
                        ;(YTPlayer.player = a.target),
                          YTPlayer.isReady ||
                            ((YTPlayer.isReady =
                              YTPlayer.isPlayer && !YTPlayer.opt.autoPlay ? !1 : !0),
                      ...
                      onError: function (a) {
                        150 == a.data &&
                          ...
                          'function' == typeof YTPlayer.opt.onError &&
                            YTPlayer.opt.onError(jQueryYTPlayer, a)
                      },
                    },
                  })
                }
    ...
    getDataFromAPI: function (a) {
      if (
        ...
        if (
          ...
          var b =
            jQuery.mbYTPlayer.locationProtocol + '//i.ytimg.com/vi/' + a.videoID + '/hqdefault.jpg'
          a.opt.containment.css({
            background: 'rgba(0,0,0,0.5) url(' + b + ') center center',
            backgroundSize: 'cover',
          }),
        ...
        jQuery(b.playerEl).CSSAnimate({ opacity: 0 }, 200, function () {
          ...
          return (
            ...
            jQuery(b)
              .YTPGetPlayer()
              .cueVideoByUrl(
                encodeURI(jQuery.mbYTPlayer.locationProtocol + '//www.youtube.com/v/' + b.videoID),
                1,
                b.opt.quality,
              ),
    ...
    toggleLoops: function () {
      ...
      return (
        1 == b.loop
          ? (b.loop = 0)
          : (b.startAt ? a.player.seekTo(b.startAt) : a.player.playVideo(), (b.loop = 1)),
        this
      )
    },
    play: function () {
    ...
    togglePlay: function (a) {
      var b = this.get(0)
      return (
        1 == b.state ? this.YTPPause() : this.YTPPlay(), 'function' == typeof a && a(b.state), this
      )
    },
    stop: function () {
      var a = this.get(0),
    ...
    enableFilters: function () {
      return this.each(function () {
        ...
        for (var d in a.filters)
          a.filters[d].value &&
            (c += d.replace('_', '-') + '(' + a.filters[d].value + a.filters[d].unit + ') ')
          ...
          ? (jQuery.mbYTPlayer.checkForStart(YTPlayer),
            void (YTPlayer.getState = setInterval(function () {
              ...
              if (
                ((YTPlayer.player.time = prog.currentTime),
                0 == YTPlayer.player.getVolume()
                  ? jQueryYTPlayer.addClass('isMuted')
                  : jQueryYTPlayer.removeClass('isMuted'),
                ...
                eval(YTPlayer.opt.stopMovieOnBlur) &&
                  (document.hasFocus()
                    ? document.hasFocus() &&
                      ...
                      -1 != YTPlayer.state &&
                      0 != YTPlayer.state &&
                      ((YTPlayer.hasFocus = !0), jQueryYTPlayer.YTPPlay())
                    : 1 == YTPlayer.state && ((YTPlayer.hasFocus = !1), jQueryYTPlayer.YTPPause())),
                YTPlayer.controlBar &&
                ...
                if (
                  ...
                  if (!data.loop || (data.loop > 0 && YTPlayer.player.LoopTime === data.loop - 1)) {
                    ...
                    return (
                      (YTPEnd.time = YTPlayer.player.time), void jQuery(YTPlayer).trigger(YTPEnd)
                    )
                  }
                } else if (
                  !data.loop ||
                  ...
                  return (
                    ...
                    jQuery(YTPlayer).YTPPause(),
                    void YTPlayer.wrapper.CSSAnimate({ opacity: 0 }, 1e3, function () {
        ...
        if (a.player.getDuration() > 0 && a.player.getCurrentTime() >= c && d) {
          ...
          if (
            ...
            ;(f.time = a.player.time),
              ...
              jQuery(a.playerEl).CSSAnimate({ opacity: 1 }, 1e3),
              a.wrapper.CSSAnimate({ opacity: a.isAlone ? 1 : a.opt.opacity }, 1e3)
          } else
            a.player.pauseVideo(),
              a.isPlayer ||
                (jQuery(a.playerEl).CSSAnimate({ opacity: 1 }, 1e3),
    ...
    (jQuery.fn.optimizeDisplay = function () {
      ...
      b.optimizeDisplay
        ? ((h.width = d.width + (d.width * f) / 100),
          (h.height =
            '16/9' == b.ratio ? Math.ceil((9 * d.width) / 16) : Math.ceil((3 * d.width) / 4)),
          (h.marginTop = -((h.height - d.height) / 2)),
          (h.marginLeft = -((d.width * (f / 2)) / 100)),
          h.height < d.height &&
            ((h.height = d.height + (d.height * f) / 100),
            (h.width =
              '16/9' == b.ratio ? Math.floor((16 * d.height) / 9) : Math.floor((4 * d.height) / 3)),
              ...
              function () {
                return g.called || !e
                  ...
                  : (h.css(jQuery.CSS.sfx + 'transition', ''),
                    e.apply(g),
                    (g.CSSAIsRunning = !1),
                    void ('function' == typeof g.CSSqueue && (g.CSSqueue(), (g.CSSqueue = null))))
              },
              b + c + 10,
            ))
        }
    ...
    ;(a.simpleSlider = {
      ...
      updateSliderVal: function (b) {
        ...
        var d = this,
          e = d.get(0)
        e.opt.initialval =
          'number' == typeof e.opt.initialval ? e.opt.initialval : e.opt.initialval(e)
        ...
        ;(e.x =
          ...
          (e.outOfRangeX =
            e.scaleX > e.opt.scale ? e.scaleX - e.opt.scale : e.scaleX < 0 ? e.scaleX : 0),
          (e.outOfRangeY =
            e.scaleY > e.opt.scale ? e.scaleY - e.opt.scale : e.scaleY < 0 ? e.scaleY : 0),
