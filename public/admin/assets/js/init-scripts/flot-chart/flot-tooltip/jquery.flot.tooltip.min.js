  ...
  ;(c.prototype.init = function (b) {
    ...
    (c.prototype.stringFormat = function (a, b) {
      ...
      if (
        ...
        (a =
          'undefined' != typeof b.series.label ? a.replace(i, b.series.label) : a.replace(i, '')),
        (a =
          'undefined' != typeof b.series.color ? a.replace(j, b.series.color) : a.replace(j, '')),
    ...
    (c.prototype.isCategoriesMode = function (a, b) {
      return (
        'undefined' != typeof b.series[a].options.mode && 'categories' === b.series[a].options.mode
      )
    }),
