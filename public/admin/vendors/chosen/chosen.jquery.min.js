      ...
      return (
        ...
        (t.prototype.choice_label = function (t) {
          return this.include_group_label_in_selected && null != t.group_label
            ? "<b class='group-name'>" + this.escape_html(t.group_label) + '</b>' + t.html
            : t.html
        }),
            ...
            ((r = l[i]).search_match = !1),
              ...
              this.include_option_in_results(r) &&
                ...
                null != r.group_array_index &&
                  ...
                  (0 === (a = this.results_data[r.group_array_index]).active_options &&
                    a.search_match &&
                    (_ += 1),
                  (a.active_options += 1)),
        ...
        (t.prototype.choices_count = function () {
          ...
          for (
            this.selected_option_count = 0, t = 0, e = (s = this.form_field.options).length;
            t < e;
            t++
          )
        ...
        (t.prototype.choices_click = function (t) {
          if (
            (t.preventDefault(), this.activate_field(), !this.results_showing && !this.is_disabled)
          )
    ...
    (s = (function (s) {
      ...
      return (
        ...
        (n.prototype.search_results_mousewheel = function (t) {
          ...
          if (
            (t.originalEvent &&
              (e = t.originalEvent.deltaY || -t.originalEvent.wheelDelta || t.originalEvent.detail),
            null != e)
          )
            return (
              t.preventDefault(),
        ...
        (n.prototype.keydown_backstroke = function () {
          ...
          return this.pending_backstroke
            ? (this.choice_destroy(this.pending_backstroke.find('a').first()),
              this.clear_backstroke())
            : (t = this.search_container.siblings('li.search-choice').last()).length &&
