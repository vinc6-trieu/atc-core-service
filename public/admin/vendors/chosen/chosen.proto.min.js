      ...
      return (
        (e.prototype.set_default_values = function () {
          return (
            ...
            (this.hide_results_on_select =
              null == this.options.hide_results_on_select || this.options.hide_results_on_select)
          )
        }),
        ...
        (e.prototype.choice_label = function (e) {
          return this.include_group_label_in_selected && null != e.group_label
            ? "<b class='group-name'>" + this.escape_html(e.group_label) + '</b>' + e.html
            : e.html
        }),
        ...
        (e.prototype.results_option_build = function (e) {
          ...
          for (
            ...
            ((s = o[r]),
            (i = ''),
            '' !== (i = s.group ? this.result_add_group(s) : this.result_add_option(s)) &&
              (l++, (t += i)),
        ...
        (e.prototype.reset_single_select_options = function () {
          var e, t, s, i, r
          for (r = [], e = 0, t = (s = this.results_data).length; e < t; e++)
            (i = s[e]).selected ? r.push((i.selected = !1)) : r.push(void 0)
          return r
        }),
            ...
            ((n = h[i]).search_match = !1),
              ...
              this.include_option_in_results(n) &&
                ...
                null != n.group_array_index &&
                  ...
                  (0 === (_ = this.results_data[n.group_array_index]).active_options &&
                    _.search_match &&
                    (a += 1),
                  (_.active_options += 1)),
        ...
        (e.prototype.get_search_regex = function (e) {
          var t, s
          return (
            (s = this.search_contains ? e : '(^|\\s|\\b)' + e + '[^\\s]*'),
        ...
        (e.prototype.choices_count = function () {
          ...
          for (
            this.selected_option_count = 0, e = 0, t = (s = this.form_field.options).length;
            e < t;
            e++
          )
        ...
        (e.prototype.choices_click = function (e) {
          if (
            (e.preventDefault(), this.activate_field(), !this.results_showing && !this.is_disabled)
          )
    ...
    (this.Chosen = (function (s) {
      ...
      return (
        ...
        (r.prototype.set_up_html = function () {
          ...
          return (
            ...
            this.form_field.id.length &&
              (t.id = this.form_field.id.replace(/[^\w]/g, '_') + '_chosen'),
        ...
        (r.prototype.destroy = function () {
          ...
          for (
            this.container.ownerDocument.stopObserving('click', this.click_test_action),
              t = 0,
              s = (i = ['chosen:updated', 'chosen:activate', 'chosen:open', 'chosen:close']).length;
            t < s;
            t++
          )
        ...
        (r.prototype.search_field_disabled = function () {
          ...
          return (
            (this.is_disabled =
              ...
              (null != (e = this.form_field.up('fieldset')) ? e.disabled : void 0) ||
              !1),
            this.is_disabled
            ...
            this.is_disabled
              ...
              : this.is_multiple
                ? void 0
                : this.selected_item.observe('focus', this.activate_field)
          )
        }),
            ...
            return (
              ...
              null != e && e.target.hasClassName('search-choice-close')
                ...
                : (this.active_field
                    ? this.is_multiple ||
                      !e ||
                      (e.target !== this.selected_item && !e.target.up('a.chosen-single')) ||
                      this.results_toggle()
        ...
        (r.prototype.search_results_mousewheel = function (e) {
          var t
          if (null != (t = e.deltaY || -e.wheelDelta || e.detail))
            return (
              e.preventDefault(),
        ...
        (r.prototype.test_active_click = function (e) {
          return e.target.up('.chosen-container') === this.container
            ? (this.active_field = !0)
            : this.close_field()
        }),
        ...
        (r.prototype.result_do_highlight = function (e) {
          ...
          return (
            ...
            (t = s + this.result_highlight.getHeight()) >= r
        ...
        (r.prototype.result_clear_highlight = function () {
          return (
            this.result_highlight && this.result_highlight.removeClassName('highlighted'),
        ...
        (r.prototype.search_results_mouseup = function (e) {
          var t
          if (
            (t = e.target.hasClassName('active-result') ? e.target : e.target.up('.active-result'))
          )
            return (this.result_highlight = t), this.result_select(e), this.search_field.focus()
        }),
        ...
        (r.prototype.search_results_mouseout = function (e) {
          if (e.target.hasClassName('active-result') || e.target.up('.active-result'))
            return this.result_clear_highlight()
        }),
        (r.prototype.choice_build = function (e) {
          var t, s
          return (
            (t = new Element('li', { class: 'search-choice' }).update(
        ...
        (r.prototype.results_reset_cleanup = function () {
          ...
          if (
            ...
            (e = this.selected_item.down('abbr')))
          )
            return e.remove()
        }),
          ...
          if (this.result_highlight)
            return (
              ...
              this.is_multiple && this.max_selected_options <= this.choices_count()
                ? (this.form_field.fire('chosen:maxselected', { chosen: this }), !1)
                : (this.is_multiple
                    ? t.removeClassName('active-result')
                    : this.reset_single_select_options(),
        ...
        (r.prototype.winnow_results_set_highlight = function () {
          var e
          if (
            (this.is_multiple || (e = this.search_results.down('.result-selected.active-result')),
            null == e && (e = this.search_results.down('.active-result')),
            null != e)
          )
        ...
        (r.prototype.no_results = function (e) {
          return (
            this.search_results.insert(this.get_no_results_html(e)),
        ...
        (r.prototype.keydown_arrow = function () {
          ...
          return this.results_showing && this.result_highlight
            ? (e = this.result_highlight.next('.active-result'))
        ...
        (r.prototype.keydown_backstroke = function () {
          ...
          return this.pending_backstroke
            ...
            : (e = this.search_container.siblings().last()) &&
                e.hasClassName('search-choice') &&
                !e.hasClassName('search-choice-disabled')
