    ...
    for (
      ...
      (window.requestAnimationFrame = window[o + 'RequestAnimationFrame']),
        (window.cancelAnimationFrame =
          window[o + 'CancelAnimationFrame'] || window[o + 'CancelRequestAnimationFrame'])
    ;(t = null),
      (s = 0),
      (i = {}),
          ...
          return (
            ...
            !(!t && this.displayedValue === this.value) &&
              ...
              Math.abs(i / this.animationSpeed) <= 0.001
                ...
                : (this.displayedValue = this.displayedValue + i / this.animationSpeed),
              this.render(),
              !0)
          )
        }),
      ...
      return (
        ...
        (i.prototype.setMinValue = function (t, i) {
          ...
          if (((this.minValue = t), null == i && (i = !0), i)) {
            for (
              this.displayedValue = this.minValue, o = this.gp || [], a = [], s = 0, n = o.length;
              s < n;
              s++
            )
    ...
    (t = (function (t) {
      ...
      return (
        ...
        (i.prototype.render = function () {
          var t
          return (
            (t = this.text ? u(this.displayedValue.toFixed(0)) : r(p(this.displayedValue))),
      ...
      return (
        ...
        (i.prototype.setOptions = function (t) {
          if (
            ...
            (this.options = c(this.options, t)),
            (this.length =
              2 * this.gauge.radius * this.gauge.options.radiusScale * this.options.length),
          ...
          for (
            null == t && (t = null),
              ...
              this.options.angle < 0 &&
                ((o = Math.PI * (1 + this.options.angle)), (this.extraPadding = Math.sin(o))),
        ...
        (i.prototype.configPercentColors = function () {
          ...
          if (((this.percentColors = null), void 0 !== this.options.percentColors)) {
            for (
              ...
              (a = parseInt(l(this.options.percentColors[e][1]).substring(0, 2), 16)),
                (i = parseInt(l(this.options.percentColors[e][1]).substring(2, 4), 16)),
                (t = parseInt(l(this.options.percentColors[e][1]).substring(4, 6), 16)),
                o.push(
        ...
        (i.prototype.set = function (t) {
          ...
          if (t.length > this.gp.length)
            for (
              ...
              (i = new o(this)), i.setOptions(this.options.pointer), this.gp.push(i)
            ...
            (p = t[a]),
              p > this.maxValue
                ? this.options.limitMax
                  ...
                  : (this.maxValue = p + 1)
                : p < this.minValue &&
                  (this.options.limitMin ? (p = this.minValue) : (this.minValue = p - 1)),
              (this.gp[e].value = p),
          ...
          return (
            (this.value = Math.max(Math.min(t[t.length - 1], this.maxValue), this.minValue)),
            ...
            (g = c[a]),
              void 0 !== g.label
                ...
                : (!this.options.limitMin || g >= this.minValue) &&
                  ...
                  this.ctx.rotate(d),
                  this.ctx.fillText(p(g, t.fractionDigits), 0, -s - this.lineWidth / 2),
                  this.ctx.rotate(-d))
          ...
          if (t !== {}) {
            for (
              ...
              (this.ctx.lineWidth = this.lineWidth * h),
                ...
                this.ctx.beginPath(),
                this.ctx.arc(0, 0, C, this.getAngle(n - r), this.getAngle(n + r), !1),
                this.ctx.stroke(),
                (o = n + y),
                (n += d),
                M !== t.divisions && S > 0
                      ...
                      function () {
                        ...
                        for (e = [], f = t = 0, i = S - 1; t < i; f = t += 1)
                          (this.ctx.lineWidth = this.lineWidth * V),
                            ...
                            this.ctx.beginPath(),
                            this.ctx.arc(0, 0, C, this.getAngle(o - w), this.getAngle(o + w), !1),
                            this.ctx.stroke(),
                            e.push((o += y))
                        return e
                      }.call(this),
        ...
        (i.prototype.render = function () {
          ...
          if (
            ...
            for (
              ...
              (x = c[n]),
                (l = x.min),
                this.options.limitMin && l < this.minValue && (l = this.minValue),
                (r = x.max),
                this.options.limitMax && r > this.maxValue && (r = this.maxValue),
            ...
            void 0 !== this.options.customFillStyle
              ...
              this.ctx.translate(m, s)
          for (
            this.options.renderTicks && this.renderTicks(this.options.renderTicks, m, s, p),
              this.ctx.restore(),
              this.ctx.translate(m, s),
              u = this.gp,
              o = 0,
      ...
      return (
        ...
        (i.prototype.render = function () {
          ...
          return (
            ...
            (this.ctx.strokeStyle = i),
            this.ctx.beginPath(),
            this.ctx.arc(s, e, this.radius, (1 - this.options.angle) * Math.PI, t, !1),
            this.ctx.stroke()
          )
        }),
        i
    ...
    (window.AnimationUpdater = {
      ...
      run: function (t) {
        ...
        if ((null == t && (t = !1), isFinite(parseFloat(t)) || !0 === t)) {
          for (e = !0, o = AnimationUpdater.elements, s = 0, n = o.length; s < n; s++)
            (i = o[s]), i.update(!0 === t) && (e = !1)
          return (AnimationUpdater.animId = e ? null : requestAnimationFrame(AnimationUpdater.run))
        }
        if (!1 === t)
          return (
            !0 === AnimationUpdater.animId && cancelAnimationFrame(AnimationUpdater.animId),
