...
;(function (h) {
  ...
  function Jb(a) {
    for (
      var b, c, d = a.aoColumns, e = X(a), a = a.oLanguage.oAria, f = 0, g = d.length;
      f < g;
      f++
    ) {
      c = d[f]
  ...
  var n = function (a) {
      ...
      this.each(function () {
        ...
        if ('table' != this.nodeName.toLowerCase())
          ...
          g.bStateSave
            ? ((U.bStateSave = !0), z(p, 'aoDrawCallback', xa, 'state_save'), Kb(p, g, e))
            : e()
        }
      })
      b = null
  ...
  s.extend = function (a, b, c) {
    if (c.length && b && (b instanceof s || b.__dt_wrapper)) {
      ...
      for (e = c.length; d < e; d++)
        (f = c[d]),
          (b[f.name] =
            'function' === typeof f.val ? g(a, f.val, f) : h.isPlainObject(f.val) ? {} : f.val),
  ...
  o('draw()', function (a) {
    return this.iterator('table', function (b) {
      'page' === a
        ? P(b)
        : ('string' === typeof a && (a = 'full-hold' === a ? !1 : !0), T(b, !1 === a))
    })
  })
  o('page()', function (a) {
    return a === k
