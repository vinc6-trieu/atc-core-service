$(function () {
  ...
  QUnit.test('should add "collapsed" class to target when collapse is hidden', function (assert) {
    ...
    var $target = $('<a role="button" data-toggle="collapse" href="#test1"/>').appendTo(
      '#qunit-fixture',
    )
  ...
  QUnit.test(
    ...
    function (assert) {
      ...
      var $alt = $('<a role="button" data-toggle="collapse" href="#test1"/>').appendTo(
        '#qunit-fixture',
      )
  ...
  QUnit.test('should remove "collapsed" class from active accordion target', function (assert) {
    ...
    var $target1 = $('<a role="button" data-toggle="collapse" href="#body1" />').appendTo(
      $groups.eq(0),
    )
  ...
  QUnit.test(
    ...
    function (assert) {
      ...
      var accordionHTML =
        '<div id="accordion">' + '<div class="card"/>' + '<div class="card"/>' + '</div>'
      var showFired = false
      var $groups = $(accordionHTML).appendTo('#qunit-fixture').find('.card')
      ...
      var $target2 = $('<a role="button" data-toggle="collapse" href="#body2"/>').appendTo(
        $groups.eq(1),
      )
      var $body2 = $('<div id="body2" class="collapse" data-parent="#accordion"/>').appendTo(
        $groups.eq(1),
      )
  ...
  QUnit.test(
    ...
    function (assert) {
      ...
      var $trigger1 = $('<a role="button" data-toggle="collapse" href="#test1"/>').appendTo(
        '#qunit-fixture',
      )
      var $trigger2 = $('<a role="button" data-toggle="collapse" href="#test2"/>').appendTo(
        '#qunit-fixture',
      )
      var $trigger3 = $('<a role="button" data-toggle="collapse" href=".multi"/>').appendTo(
        '#qunit-fixture',
      )
