  ...
  return function (A) {
    ...
    ;(this.options = A || {}),
      ...
      (this.add = function (A) {
        ...
        for (
          ...
          if (this.hasAnchorJSLink(n[r])) p.push(r)
            ...
            if (n[r].hasAttribute('id')) a = n[r].getAttribute('id')
            else if (n[r].hasAttribute('data-anchor-id')) a = n[r].getAttribute('data-anchor-id')
            else {
            ...
            a.replace(/-/g, ' '),
              ...
              'left' === this.options.placement
                ...
                : ((d.style.paddingLeft = '0.375em'), n[r].appendChild(d))
          }
      ...
      (this.remove = function (A) {
        for (var e, i, n = t(A), o = 0; o < n.length; o++)
          (i = n[o].querySelector('.anchorjs-link')) &&
            (-1 !== (e = this.elements.indexOf(n[o])) && this.elements.splice(e, 1),
            n[o].removeChild(i))
        return this
      }),
      ...
      (this.hasAnchorJSLink = function (A) {
        var e =
            A.firstChild && (' ' + A.firstChild.className + ' ').indexOf(' anchorjs-link ') > -1,
