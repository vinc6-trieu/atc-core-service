        ...
        for (
          t.documentElement.firstChild.appendChild(i),
            ...
            i.styleSheet.cssText =
              n + '{x-qsa:expression(document._qsa && document._qsa.push(this))}',
            e.scrollBy(0, 0),
        ...
        ;(function (t) {
          ...
          function o(e) {
            ...
            ;(r.theme = s),
              ...
              ('image' != t && 'fluid' != t) ||
                x.setAttr(n, { alt: s.text ? (d ? s.text : s.text + ' [' + l + ']') : l })
            var b = {
              mode: t,
              el: n,
            ...
            'image' == t
              ? (r.auto || ((n.style.width = o.width + 'px'), (n.style.height = o.height + 'px')),
                'html' == v.renderer
                  ...
                  : (a(b),
                    'exact' == r.textmode &&
                      ((n.holderData.resizeUpdate = !0), O.vars.resizableImages.push(n), h(n))))
          ...
          function a(e) {
            ...
            'background' == i
              ? ((o.style.backgroundImage = 'url(' + r + ')'),
                l.noBackgroundSize || (o.style.backgroundSize = h.width + 'px ' + h.height + 'px'))
            ...
            for (var n = 0, r = t.length; n < r; n++) {
              ...
              if (i.holderData) {
                ...
                if (s) {
                  ...
                  'exact' == o.textmode &&
                    ((o.exactDimensions = s), (h.holderSettings.dimensions = o.dimensions)),
                    a(h)
                } else f(i)
              }
            }
          ...
          var m = n(2),
            ...
            F = {
              ...
              setResizeUpdate: function (e, t) {
                e.holderData &&
                  ((e.holderData.resizeUpdate = !!t), e.holderData.resizeUpdate && h(e))
              },
              run: function (e) {
                e = e || {}
                var n = {},
