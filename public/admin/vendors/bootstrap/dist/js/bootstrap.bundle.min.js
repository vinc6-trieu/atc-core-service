...
!(function (e, t) {
    ...
    var r,
      ...
      Se =
        ...
        (re = (function () {
          ...
          return (
            ...
            (e._getItemIndex = function (e) {
              return (
                (this._items =
                  e && e.parentNode ? [].slice.call(e.parentNode.querySelectorAll($)) : []),
        ...
        k(window).on(q.LOAD_DATA_API, function () {
          for (
            var e = [].slice.call(document.querySelectorAll(ie)), t = 0, n = e.length;
            t < n;
            t++
          ) {
            var i = k(e[t])
      ...
      De =
        ...
        (be = (function () {
          function a(t, e) {
            ...
            for (
              var n = [].slice.call(document.querySelectorAll(Ee)), i = 0, r = n.length;
              i < r;
              i++
            ) {
              var o = n[i],
          ...
          return (
                ...
                if ((oe(this._element).trigger(i), !i.isDefaultPrevented())) {
                  ...
                  oe(this._element).removeClass(pe).addClass(me),
                    ...
                    this._triggerArray.length &&
                      oe(this._triggerArray).removeClass(ge).attr('aria-expanded', !0),
            ...
            (e._getConfig = function (e) {
              return (
                ((e = l({}, ue, e)).toggle = Boolean(e.toggle)), we.typeCheckConfig(se, e, fe), e
              )
            }),
  ...
  function Ue(e, t) {
    ...
    if ((e !== l && t !== l) || i.contains(r))
      return 'BODY' === (a = (s = l).nodeName) || ('HTML' !== a && We(s.firstElementChild) !== s)
        ? We(l)
        : l
    var c = Re(e)
            ...
            var c = i.priority,
              ...
              f = {
                primary: function (e) {
                  var t = u[e]
                  return (
                    u[e] < l[e] && !i.escapeWithReference && (t = Math.max(u[e], l[e])),
                    Ve({}, e, t)
                  )
                },
        ...
        return (
          ...
          (c._jQueryInterface = function (t) {
            return this.each(function () {
              ...
              if (
                (e || ((e = new c(this, 'object' == typeof t ? t : null)), Tt(this).data(Dt, e)),
                'string' == typeof t)
              ) {
          ...
          (c._clearMenus = function (e) {
            if (!e || (3 !== e.which && ('keyup' !== e.type || 9 === e.which)))
              for (
                var t = [].slice.call(document.querySelectorAll(Wt)), n = 0, i = t.length;
                n < i;
                n++
              ) {
            ...
            if (
              (/input|textarea/i.test(e.target.tagName)
                ? !(
                    32 === e.which ||
                    (27 !== e.which &&
                      ((40 !== e.which && 38 !== e.which) || Tt(e.target).closest(Ut).length))
                  )
                : Nt.test(e.which)) &&
          ...
          (e.show = function () {
            ...
            if (this.isWithContent() && this._isEnabled) {
              ...
              yn(i).data(this.constructor.DATA_KEY, this),
                yn.contains(this.element.ownerDocument.documentElement, this.tip) ||
                  yn(i).appendTo(a),
        ...
        return (
          ...
          (n._jQueryInterface = function (t) {
            return this.each(function () {
              ...
              if (
                (e || ((e = new n(this, 'object' == typeof t && t)), ni(this).data(ri, e)),
                'string' == typeof t)
              ) {
                if ('undefined' == typeof e[t]) throw new TypeError('No method named "' + t + '"')
                e[t]()
