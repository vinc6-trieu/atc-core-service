...
!(function (a, b) {
  ...
  return (
    ...
    (j.on = function (a, b, c) {
      ...
      return (
        (b.registered_events[a] = b.registered_events[a] || []), b.registered_events[a].push(d), d
      )
    }),
    (j.off = function (a, b) {
    ...
    (j.once = function (a, b, c) {
      if (j.custom_events.indexOf(a) == -1)
        return b instanceof j && (b = b.map), google.maps.event.addListenerOnce(b, a, c)
    }),
          ...
          for (var c = !1, d = this.getPaths().getLength(), e = 0; e < d; e++)
            for (
              ...
              ;((j.lng() < a.lng() && k.lng() >= a.lng()) ||
                ...
                j.lat() + ((a.lng() - j.lng()) / (k.lng() - j.lng())) * (k.lat() - j.lat()) <
                  a.lat() &&
                (c = !c),
                (h = i)
            }
