...
function c(e) {
  ...
  return n && 'BODY' !== n && 'HTML' !== n
    ? -1 !== ['TD', 'TABLE'].indexOf(o.nodeName) && 'static' === s(o, 'position')
      ? c(o)
      : o
    : e
...
function q(e, t, o, n) {
  ;(o.updateBound = n), z(e).addEventListener('resize', o.updateBound, { passive: !0 })
  const i = a(e)
  return (
    G(i, 'scroll', o.updateBound, o.scrollParents), (o.scrollElement = i), (o.eventsEnabled = !0), o
  )
}
function V() {
...
function te(e, t) {
  ...
  if (
    ((w =
      'bottom' == h
        ? 'HTML' === f.nodeName
          ? -f.clientHeight + m.bottom
          : -a.height + m.bottom
        : m.top),
    (b =
      'right' == u
        ? 'HTML' === f.nodeName
          ? -f.clientWidth + m.right
          : -a.width + m.right
        : m.left),
    s && g)
  )
    (l[g] = `translate3d(${b}px, ${w}px, 0)`), (l[h] = 0), (l[u] = 0), (l.willChange = 'transform')
  else {
...
var we = {
    ...
    computeStyle: { order: 850, enabled: !0, fn: te, gpuAcceleration: !0, x: 'bottom', y: 'right' },
