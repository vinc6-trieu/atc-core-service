...
function g(e) {
  ...
  for (var t = c(10) ? document.body : null, o = e.offsetParent; o === t && e.nextElementSibling; )
    o = (e = e.nextElementSibling).offsetParent
  var n = o && o.nodeName
  return n && 'BODY' !== n && 'HTML' !== n
    ? -1 !== ['TD', 'TABLE'].indexOf(o.nodeName) && 'static' === a(o, 'position')
      ? g(o)
      : o
    : e
...
function P(e, t) {
  ...
  var g = C({ top: p.top - s.top - m, left: p.left - s.left - h, width: p.width, height: p.height })
...
function K(e, t, o) {
  var n = void 0 === o ? e : e.slice(0, j(e, 'name', o))
  return (
...
function Q(e, t, o, n) {
  ...
  var i = f(e)
  return (
    X(i, 'scroll', o.updateBound, o.scrollParents), (o.scrollElement = i), (o.eventsEnabled = !0), o
  )
}
function Z() {
...
function ie(e, t, o, n, i) {
  ...
  return (
    t.setAttribute('x-placement', p), te(t, { position: o.positionFixed ? 'fixed' : 'absolute' }), o
  )
}
function re(e, t) {
  var o = Math.round,
  ...
  var d,
    ...
    c = { left: n(p.left), top: o(p.top), bottom: o(p.bottom), right: n(p.right) },
  ...
  if (
    ((a =
      'bottom' == u
        ? 'HTML' === f.nodeName
          ? -f.clientHeight + c.bottom
          : -m.height + c.bottom
        : c.top),
    (d =
      'right' == b
        ? 'HTML' === f.nodeName
          ? -f.clientWidth + c.right
          : -m.width + c.right
        : c.left),
    l && y)
  )
  ...
  return (
    (e.attributes = D({}, x, e.attributes)),
    (e.styles = D({}, h, e.styles)),
...
var me = { FLIP: 'flip', CLOCKWISE: 'clockwise', COUNTERCLOCKWISE: 'counterclockwise' }
function he(e, t) {
...
var ve = {
    ...
    computeStyle: { order: 850, enabled: !0, fn: re, gpuAcceleration: !0, x: 'bottom', y: 'right' },
  ...
  Le = (function () {
    function e(t, o) {
      ...
      L(this, e),
        ...
        (this.options = D({}, e.Defaults, i)),
        (this.state = { isDestroyed: !1, isCreated: !1, scrollParents: [] }),
        (this.reference = t && t.jquery ? t[0] : t),
        (this.popper = o && o.jquery ? o[0] : o),
        (this.options.modifiers = {}),
        Object.keys(D({}, e.Defaults.modifiers, i.modifiers)).forEach(function (t) {
        ...
        (this.modifiers = Object.keys(this.options.modifiers)
          .map(function (e) {
            return D({ name: e }, n.options.modifiers[e])
          })
          .sort(function (e, t) {
