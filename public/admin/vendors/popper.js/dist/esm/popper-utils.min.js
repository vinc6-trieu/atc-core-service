...
function h(b) {
  ...
  for (var c = g(10) ? document.body : null, d = b.offsetParent; d === c && b.nextElementSibling; )
    d = (b = b.nextElementSibling).offsetParent
  var e = d && d.nodeName
  return e && 'BODY' !== e && 'HTML' !== e
    ? -1 !== ['TD', 'TABLE'].indexOf(d.nodeName) && 'static' === a(d, 'position')
      ? h(d)
      : d
    : b
...
function Z(a, b, d, e) {
  ...
  var f = c(a)
  return (
    Y(f, 'scroll', d.updateBound, d.scrollParents), (d.scrollElement = f), (d.eventsEnabled = !0), d
  )
}
var $ = {
