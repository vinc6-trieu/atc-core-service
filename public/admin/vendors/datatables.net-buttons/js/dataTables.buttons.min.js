...
;(function (e) {
  ...
  e.extend(l.prototype, {
    ...
    add: function (a, b) {
      ...
      if ('string' === typeof b) {
        for (var d = b.split('-'), c = this.s, e = 0, h = d.length - 1; e < h; e++)
          c = c.buttons[1 * d[e]]
        c = c.buttons
        b = 1 * d[d.length - 1]
      }
  ...
  l.background = function (a, b, c, d) {
    ...
    d || (d = o.body)
    a
      ? e('<div/>').addClass(b).css('display', 'none').insertAfter(d).fadeIn(c)
    ...
    collection: {
      ...
      action: function (a, b, c, d) {
        var g = e(c).parents('div.dt-button-collection'),
          ...
          i = c
        g.length &&
          ((f = e('.dt-button-collection').position()),
          (i = g),
          e('body').trigger('click.dtb-collection'))
        i.parents('body')[0] !== o.body && (i = o.body.lastChild)
        d._collection.find('.dt-button-collection-title').remove()
        d._collection.prepend(
          '<div class="dt-button-collection-title">' + d.collectionTitle + '</div>',
        )
        d._collection
  ...
  i.Api.register('button().add()', function (a, b) {
    var c = this.context
    c.length &&
      ((c = l.instanceSelector(this._groupSelector, c[0]._buttons)), c.length && c[0].add(b, a))
