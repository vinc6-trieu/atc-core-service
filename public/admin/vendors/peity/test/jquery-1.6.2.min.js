...
;(function (a, b) {
  ...
  function bX(a, c, d, e, f, g) {
    ...
    for (; i < j && (k || !l); i++)
      (l = h[i](c, d, e)),
        typeof l == 'string' &&
          (!k || g[l] ? (l = b) : (c.dataTypes.unshift(l), (l = bX(a, c, d, e, l, g))))
  ...
  function bl(a) {
    f.nodeName(a, 'input')
      ? bk(a)
      : 'getElementsByTagName' in a && f.grep(a.getElementsByTagName('input'), bk)
  }
  function bk(a) {
      ...
      o.appendChild(a),
        ...
        c.defaultView &&
          ...
          (k.reliableMarginRight =
            (parseInt(
              (c.defaultView.getComputedStyle(j, null) || { marginRight: 0 }).marginRight,
              10,
            ) || 0) === 0)),
        (o.innerHTML = ''),
        n.removeChild(o)
      ...
      attr: function (a, c, d, e) {
        ...
        j &&
          ...
          i ||
            (t.test(c)
              ? (i = w)
              : v && c !== 'className' && (f.nodeName(a, 'form') || u.test(c)) && (i = v)))
        if (d !== b) {
          if (d === null) {
            f.removeAttr(a, c)
            return b
  ...
  f.fn.extend({
    ...
    is: function (a) {
      return (
        !!a && (typeof a == 'string' ? f.filter(a, this).length > 0 : this.filter(a).length > 0)
      )
    },
    ...
    f.extend({
      ...
      style: function (a, c, d, e) {
        if (!!a && a.nodeType !== 3 && a.nodeType !== 8 && !!a.style) {
          ...
          h === 'string' &&
            bs.test(d) &&
            ((d = +d.replace(bt, '') + parseFloat(f.css(a, c))), (h = 'number')),
      ...
      ;(f.fn['inner' + c] = function () {
        ...
        (f.fn[d] = function (a) {
          ...
          if (f.isWindow(e)) {
            ...
            return (
              (e.document.compatMode === 'CSS1Compat' && g) || e.document.body['client' + c] || g
            )
          }
          if (e.nodeType === 9)
            return Math.max(
