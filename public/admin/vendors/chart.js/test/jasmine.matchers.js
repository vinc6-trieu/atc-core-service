  ...
  return {
    compare: function (actual) {
      ...
      if (!(actual instanceof Chart)) {
        ...
        Object.prototype.toString.call(actual.ctx) !== '[object CanvasRenderingContext2D]'
      ) {
  ...
  return {
    compare: function (actual, expected) {
      ...
      if (actual.height !== orh) {
        message =
          'Expected chart height ' + actual.height + ' to be equal to original render height ' + orh
      } else if (actual.width !== orw) {
        message =
          'Expected chart width ' + actual.width + ' to be equal to original render width ' + orw
      }
