describe('Logarithmic Scale tests', function () {
  ...
  describe('when', function () {
    ...
    config.forEach(function (setup) {
      ...
      var description =
        'dataset has stack option and ' + setup.describe + ' and axis is "' + setup.axis + '";'
  ...
  describe('when', function () {
    ...
    config.forEach(function (setup) {
      ...
      axes.forEach(function (axis) {
        ...
        describe(
          setup.describe + ' and axis is "' + axis.id + '"; expect: ' + expectation + ';',
          function () {
            beforeEach(function () {
              var xScaleConfig = {
                type: 'logarithmic',
  ...
  describe('when', function () {
    var config = [
      ...
      },
      {
        ...
        lastTick: 80,
        describe:
          'dataset min point {x: 0, y: 0}, max point {x:78, y:78}, minNotZero {x: 1.2, y: 1.2}',
      },
      {
        dataset: [
          { x: 0, y: 0 },
        ...
        lastTick: 80,
        describe:
          'dataset min point {x: 0, y: 0}, max point {x:78, y:78}, minNotZero {x: 6.3, y: 6.3}',
      },
      {
        dataset: [
          { x: 10, y: 10 },
