describe('Core helper tests', function () {
  ...
  it('should get an angle from a point', function () {
    ...
    expect(
      helpers.getAngleFromPoint(center, {
        x: 0,
        y: 10,
      }),
    ).toEqual({
  ...
  describe('Color helper', function () {
    function isColorInstance(obj) {
      return (
        typeof obj === 'object' && obj.hasOwnProperty('values') && obj.values.hasOwnProperty('rgb')
      )
    }
  ...
  describe('Background hover color helper', function () {
    it('should return a CanvasPattern when called with a CanvasPattern', function (done) {
      var dots = new Image()
      dots.src =
        'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAA4AAAAOCAMAAAAolt3jAAAAD1BMVEUAAAD///////////////+PQt5oAAAABXRSTlMAHlFhZsfk/BEAAAAqSURBVHgBY2BgZGJmYmSAAUYWEIDzmcBcJhiXGcxlRpPFrhdmMiqgvX0AcGIBEUAo6UAAAAAASUVORK5CYII='
      dots.onload = function () {
        ...
        var backgroundColor = helpers.getHoverColor(
          chartContext.createPattern(patternCanvas, 'repeat'),
        )
