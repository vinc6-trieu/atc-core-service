        ...
        function (t, e, i) {
          ...
          ;(o.prototype = {
            ...
            (o.prototype.setValues = function (t, e) {
              ...
              if (((o.alpha = Math.max(0, Math.min(1, void 0 === l ? o.alpha : l))), 'alpha' === t))
                return !1
            ...
            (e.exports = function (t) {
              ...
              t.controllers.line = t.DatasetController.extend({
                ...
                update: function (t) {
                  ...
                  for (
                    g && 0 !== l._model.tension && r.updateBezierControlPoints(),
                      i = 0,
                      n = u.length;
                    i < n;
                    ++i
                ...
                updateElement: function (t, e, i) {
                  ...
                  void 0 !== u.radius && void 0 === u.pointRadius && (u.pointRadius = u.radius),
                    ...
                    (t._model = {
                      ...
                      pointStyle:
                        l.pointStyle || o.valueAtIndexOrDefault(u.pointStyle, e, g.pointStyle),
                      ...
                      hitRadius:
                        l.hitRadius || o.valueAtIndexOrDefault(u.pointHitRadius, e, g.hitRadius),
                    })
                },
                    ...
                    o.extend(t, {
                      ...
                      _model: {
                        ...
                        hitRadius: a.hitRadius
                          ? a.hitRadius
                          : o.valueAtIndexOrDefault(r.pointHitRadius, e, l.hitRadius),
                      },
                    }),
                  ...
                  n.scales &&
                    ...
                    a.each(r, function (n) {
                      ...
                      if (l in o && o[l].type === u)
                        ...
                        if (!c) return
                        ;(d = new c({ id: l, type: u, options: r, ctx: i.ctx, chart: i })),
                          (o[d.id] = d)
                      }
                    ...
                    a.each(
                      ...
                      function (a, o) {
                        ...
                        if (
                          (r.type &&
                            r.type !== s &&
                            (e.destroyDatasetMeta(o), (r = e.getDatasetMeta(o))),
                          (r.type = s),
                          i.push(r.type),
                          r.controller)
                        )
                  ...
                  (function (t, e, i, a) {
                    ...
                    for (o = 0, r = g.length; o < r; ++o)
                      if (
                        ...
                        if (
                          (t.hasOwnProperty(s) || (t[s] = l), (c = typeof d) == typeof (u = t[s]))
                        )
                          if ('string' === c) {
          ...
          e.exports = function (t) {
            ...
            ;(o.configMerge = function () {
              ...
              (o.getRelativePosition = function (t, e) {
                ...
                return {
                  x: (i = Math.round(
                    (((i - s.left - u) / f) * r.width) / e.currentDevicePixelRatio,
                  )),
                  y: (n = Math.round(
                    (((n - s.top - d) / g) * r.height) / e.currentDevicePixelRatio,
                  )),
                }
              }),
              ...
              (o.longestText = function (t, e, i, n) {
                ...
                n.font !== e && ((a = n.data = {}), (r = n.garbageCollect = []), (n.font = e)),
                  (t.font = e)
                var s = 0
                o.each(i, function (e) {
                    ...
                    if (
                      ...
                      if (p)
                        (F = e.left + (e.right - e.left) / 2),
                          (O =
                            'bottom' === a.position ? e.bottom - L - S.bottom : e.top + L + S.top)
                      else {
            ...
            draw: function () {
              ...
              if (e.display) {
                ...
                o.each(t.legendItems, function (n, l) {
                  ...
                  y
                    ? C + S >= s &&
                      ((_ = d.y += k), d.line++, (C = d.x = t.left + (s - u[d.line]) / 2))
                    : _ + k > t.bottom &&
                        ...
                        for (var m = r(t) - 1; m >= 0; m--) {
                          ...
                          if (l.display) {
                            ...
                            var y = t.getIndexAngle(m),
                              k = a.toDegrees(y)
                            ;(i.textAlign =
                              0 === (f = k) || 180 === f ? 'center' : f < 180 ? 'left' : 'right'),
                              (d = k),
          ...
          e.exports = function (t) {
            var e = t.Scale.extend({
              ...
              determineDataLimits: function () {
                ...
                k.length &&
                  ((k = c(k).sort(d)), (v = Math.min(v, k[0])), (b = Math.max(b, k[k.length - 1]))),
                  x.length &&
                    ((x = c(x).sort(d)),
                    (v = Math.min(v, x[0])),
