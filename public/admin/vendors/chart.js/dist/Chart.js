            ...
            Chart.Tooltip = Element.extend({
              ...
              update: function (changed) {
                ...
                if (active.length) {
                  ...
                  var labelColors = []
                  var labelTextColors = []
                  tooltipPosition = Chart.Tooltip.positioners[opts.position].call(
                    me,
                    active,
                    me._eventPosition,
                  )
          ...
          module.exports = function (Chart) {
            ...
            var LogarithmicScale = Chart.Scale.extend({
              ...
              handleTickRangeOptions: function () {
                ...
                if (me.max === null) {
                  me.max =
                    me.min !== 0 ? Math.pow(10, Math.floor(helpers.log10(me.min)) + 1) : DEFAULT_MAX
                }
              ...
              getPixelForValue: function (value) {
                ...
                if (value !== start) {
                  ...
                  if (value !== 0) {
                    offset +=
                      (innerDimension / (log10(end) - log10(start))) * (log10(value) - log10(start))
                  }
                  pixel += sign * offset
                }
                return pixel
