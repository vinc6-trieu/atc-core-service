        ...
        function (t, e, i) {
          ...
          ;(n = this),
            (a = function () {
              ...
              function l(t) {
                return (
                  'number' == typeof t || '[object Number]' === Object.prototype.toString.call(t)
                )
              }
              function u(t) {
                    ...
                    (t._d = (
                      t._useUTC
                        ...
                        : function (t, e, i, n, a, r, o) {
                            ...
                            return (
                              t < 100 && t >= 0 && isFinite(s.getFullYear()) && s.setFullYear(t), s
                            )
                          }
                    ).apply(null, s)),
                ...
                if (t._f !== a.ISO_8601)
                  if (t._f !== a.RFC_2822) {
                    ...
                    for (n = q(t._f, t._locale).match(H) || [], e = 0; e < n.length; e++)
                      (r = n[e]),
                        (i = (d.match(ht(r, t)) || [])[0]) &&
                          ((o = d.substr(0, d.indexOf(i))).length > 0 && g(t).unusedInput.push(o),
                                        ...
                                        null === (h = xe.exec(n._i))
                                          ? (_e(n),
                                            !1 === n._isValid &&
                                              ...
                                              Se(n),
                                              !1 === n._isValid &&
                                                (delete n._isValid, a.createFromInputFallback(n))))
                                          : (n._d = new Date(+h[1])))
                                      : r(i)
              ...
              ;(di.add = Je),
                ...
                (di.from = function (t, e) {
                  return this.isValid() && ((_(t) && t.isValid()) || Te(t).isValid())
                    ? Ue({ to: this, from: t }).locale(this.locale()).humanize(!e)
                ...
                (di.to = function (t, e) {
                  return this.isValid() && ((_(t) && t.isValid()) || Te(t).isValid())
                    ? Ue({ from: this, to: t }).locale(this.locale()).humanize(!e)
                    : this.localeData().invalidDate()
                }),
                (di.toNow = function (t) {
                  return this.to(Te(), t)
                ...
                (di.isBetween = function (t, e, i, n) {
                  return (
                    ('(' === (n = n || '()')[0] ? this.isAfter(t, i) : !this.isBefore(t, i)) &&
                ...
                (di.local = function (t) {
                  return (
                    this._isUTC &&
                      (this.utcOffset(0, t), (this._isUTC = !1), t && this.subtract(Ve(this), 'm')),
                    this
                  )
                }),
                ...
                (di.hasAlignedHourOffset = function (t) {
                  return (
                    !!this.isValid() &&
                    ((t = t ? Te(t).utcOffset() : 0), (this.utcOffset() - t) % 60 == 0)
                  )
                }),
                (di.isDST = function () {
                  return (
              ...
              function mi(t, e, i, n) {
                'boolean' == typeof t
                  ...
                  : ((i = e = t), (t = !1), l(e) && ((i = e), (e = void 0)), (e = e || ''))
                var a,
                  r = he(),
                  o = t ? r._week.dow : 0
              ...
              ;(ci.calendar = function (t, e, i) {
                ...
                (ci.monthsShortRegex = function (t) {
                  return this._monthsParseExact
                    ...
                    : (h(this, '_monthsShortRegex') || (this._monthsShortRegex = Nt),
                ...
                (ci.weekdaysShortRegex = function (t) {
                  return this._weekdaysParseExact
                    ...
                    : (h(this, '_weekdaysShortRegex') || (this._weekdaysShortRegex = Jt),
              ...
              return (
                ...
                (a.relativeTimeThreshold = function (t, e) {
                  return (
                    void 0 !== zi[t] &&
                    (void 0 === e ? zi[t] : ((zi[t] = e), 's' === t && (zi.ss = e - 1), !0))
                  )
                }),
              ...
              ;(t.controllers.bar = t.DatasetController.extend({
                    ...
                    k =
                      'flex' === _.barThickness
                        ...
                        : ((n = e),
                          ...
                          (h = a.pixels[n]),
                          r.isNullOrUndef(u)
                            ? ((s = a.min * o.categoryPercentage), (l = o.barPercentage))
                            : ((s = u * d), (l = 1)),
                ...
                setHoverStyle: function (t) {
                  ...
                  ;(a.backgroundColor = n.hoverBackgroundColor
                    ...
                    (a.borderWidth = n.hoverBorderWidth
                      ? n.hoverBorderWidth
                      : r.valueAtIndexOrDefault(e.hoverBorderWidth, i, a.borderWidth))
                },
                removeHoverStyle: function (t) {
                  ...
                  ;(a.backgroundColor = n.backgroundColor
                    ? n.backgroundColor
                    : r.valueAtIndexOrDefault(e.backgroundColor, i, o.backgroundColor)),
                    (a.borderColor = n.borderColor
                      ? n.borderColor
                      : r.valueAtIndexOrDefault(e.borderColor, i, o.borderColor)),
                    (a.borderWidth = n.borderWidth
                      ? n.borderWidth
                      : r.valueAtIndexOrDefault(e.borderWidth, i, o.borderWidth))
                },
              })),
              ...
              t.controllers.doughnut = t.controllers.pie = t.DatasetController.extend({
                ...
                updateElement: function (t, e, i) {
                  ...
                  this.removeHoverStyle(t),
                    (i && l.animateRotate) ||
                      ((y.startAngle =
                        0 === e ? s.rotation : n.getMeta().data[e - 1]._model.endAngle),
            ...
            (e.exports = function (t) {
              ...
              t.controllers.line = t.DatasetController.extend({
                ...
                update: function (t) {
                    ...
                    g &&
                      ...
                      (l._model = {
                        ...
                        cubicInterpolationMode: a.cubicInterpolationMode
                          ...
                          : r.valueOrDefault(f.cubicInterpolationMode, h.cubicInterpolationMode),
                      }),
                      l.pivot()),
                      i = 0,
                      n = u.length;
                  ...
                  for (
                    g && 0 !== l._model.tension && o.updateBezierControlPoints(),
                      i = 0,
                      n = u.length;
                    i < n;
                    ++i
                ...
                updateElement: function (t, e, i) {
                  ...
                  void 0 !== u.radius && void 0 === u.pointRadius && (u.pointRadius = u.radius),
                    ...
                    (t._model = {
                      ...
                      pointStyle:
                        l.pointStyle || r.valueAtIndexOrDefault(u.pointStyle, e, g.pointStyle),
                      ...
                      hitRadius:
                        l.hitRadius || r.valueAtIndexOrDefault(u.pointHitRadius, e, g.hitRadius),
                    })
                },
                ...
                setHoverStyle: function (t) {
                  ...
                  ;(a.radius =
                    ...
                    (a.borderWidth =
                      n.hoverBorderWidth ||
                      r.valueAtIndexOrDefault(e.pointHoverBorderWidth, i, a.borderWidth))
                },
                removeHoverStyle: function (t) {
                  var e = this,
                ...
                update: function (t) {
                  ...
                  ;(i.outerRadius = Math.max((l - s.borderWidth / 2) / 2, 0)),
                    (i.innerRadius = Math.max(
                      o.cutoutPercentage ? (i.outerRadius / 100) * o.cutoutPercentage : 1,
                      0,
                    )),
                    (i.radiusLength = (i.outerRadius - i.innerRadius) / i.getVisibleDatasetCount()),
                ...
                removeHoverStyle: function (t) {
                  ...
                  ;(a.radius = i.radius
                    ...
                    (a.backgroundColor = i.backgroundColor
                      ? i.backgroundColor
                      : r.valueAtIndexOrDefault(e.pointBackgroundColor, n, o.backgroundColor)),
                    (a.borderColor = i.borderColor
                      ? i.borderColor
                      : r.valueAtIndexOrDefault(e.pointBorderColor, n, o.borderColor)),
                    (a.borderWidth = i.borderWidth
                      ? i.borderWidth
                      : r.valueAtIndexOrDefault(e.pointBorderWidth, n, o.borderWidth))
                },
              })
            })
        },
                ...
                (t.animationService = {
                  ...
                  startDigest: function () {
                    var t = this,
                      ...
                      i = 0
                    t.dropFrames > 1 &&
                      ((i = Math.floor(t.dropFrames)), (t.dropFrames = t.dropFrames % 1)),
                      t.advance(1 + i)
                    var n = Date.now()
                  ...
                  n.scales &&
                    ...
                    a.each(o, function (n) {
                      ...
                      if (l in r && r[l].type === u)
                        ...
                        if (!h) return
                        ;(d = new h({ id: l, type: u, options: o, ctx: i.ctx, chart: i })),
                          (r[d.id] = d)
                      }
                    ...
                    a.each(
                      ...
                      function (a, r) {
                        ...
                        if (
                          (o.type &&
                            o.type !== s &&
                            (e.destroyDatasetMeta(r), (o = e.getDatasetMeta(r))),
                          (o.type = s),
                          i.push(o.type),
                          o.controller)
                        )
                  ...
                  if (!1 !== l.notify(e, 'beforeEvent', [t])) {
                    ...
                    return (
                      a
                        ...
                        : n &&
                          !e.animating &&
                          (e.stop(), e.render(e.options.hover.animationDuration, !0)),
                      (e._bufferedRender = !1),
                  ...
                  (function (t, e, i, a) {
                    ...
                    for (r = 0, o = g.length; r < o; ++r)
                      if (
                        ...
                        if (
                          (t.hasOwnProperty(s) || (t[s] = l), (h = typeof d) == typeof (u = t[s]))
                        )
                          if ('string' === h) {
          ...
          e.exports = function (t) {
            ...
            ;(r.configMerge = function () {
              return r.merge(r.clone(arguments[0]), [].slice.call(arguments, 1), {
                merger: function (e, i, n, a) {
                  ...
                  'scales' === e
                    ...
                    : 'scale' === e
                      ? (i[e] = r.merge(o, [t.scaleService.getScaleDefaults(s.type), s]))
                      : r._merger(e, i, n, a)
                },
              })
            }),
                      ...
                      for (i[e] || (i[e] = []), o = 0; o < u; ++o)
                        (l = n[e][o]),
                          ...
                          !i[e][o].type || (l.type && l.type !== i[e][o].type)
                            ? r.merge(i[e][o], [t.scaleService.getScaleDefaults(s), l])
                            : r.merge(i[e][o], l)
              ...
              (r.getRelativePosition = function (t, e) {
                ...
                return {
                  x: (i = Math.round(
                    (((i - s.left - u) / f) * o.width) / e.currentDevicePixelRatio,
                  )),
                  y: (n = Math.round(
                    (((n - s.top - d) / g) * o.height) / e.currentDevicePixelRatio,
                  )),
                }
              }),
        ...
        function (t, e, i) {
          ...
          function l(t, e, i) {
            ...
            return (
              i &&
                (n -=
                  0 === e ? (t.getPixelForTick(1) - n) / 2 : (n - t.getPixelForTick(e - 1)) / 2),
              n
            )
          }
          n._set('scale', {
                ...
                fit: function () {
                  ...
                  if (u.display && c) {
                    ...
                    if (f) {
                      ...
                      0 !== t.labelRotation
                        ? ((t.paddingLeft = 'bottom' === l.position ? k * M + 3 : k * b + 3),
                          (t.paddingRight = 'bottom' === l.position ? k * b + 3 : k * S + 3))
                ...
                _autoSkip: function (t) {
                  ...
                  for (
                    l.maxTicksLimit && (a = l.maxTicksLimit),
                      s &&
                        ((e = !1),
                        (c + l.autoSkipPadding) * u > o.width - (o.paddingLeft + o.paddingRight) &&
                          (e =
                            1 +
                            Math.floor(
                ...
                draw: function (t) {
                  ...
                  if (a.display) {
                    ...
                    if (
                      ...
                      if (m)
                        (A = e.left + (e.right - e.left) / 2),
                          (F =
                            'bottom' === a.position ? e.bottom - L - M.bottom : e.top + L + M.top)
                      else {
                    ...
                    if (c.drawBorder) {
                      ...
                      m
                        ? ((z = H = 'top' === a.position ? e.bottom : e.top), (z += V), (H += V))
                        : ((Y = N = 'left' === a.position ? e.right : e.left), (Y += V), (N += V)),
                        s.beginPath(),
                        s.moveTo(Y, z),
                        s.lineTo(N, H),
                        s.stroke()
                  ...
                  if (P.length) {
                    ...
                    S.filter &&
                      ...
                      'right' === m
                        ? (d -= s.width)
                        : 'center' === m &&
                          ((d -= s.width / 2) + s.width > u.width && (d = u.width - s.width),
                          d < 0 && (d = 0)),
              ...
              for (n = 0; n < g; ++n)
                (d = null),
                  (r = (i = t.getDatasetMeta(n)).dataset) &&
                    r._model &&
                    r instanceof a.Line &&
                    (d = { visible: t.isDatasetVisible(n), fill: s(r, n, g), chart: t, el: r }),
                  (i.$filler = d),
                  p.push(d)
              for (n = 0; n < g; ++n)
                (d = p[n]) &&
                  ...
                  (d.mapper =
                    ...
                    (c = (h = d).fill),
                    (f = 'dataset'),
                    !1 === c ? null : (isFinite(c) || (f = 'boundary'), o[f](h)))))
            },
              ...
              if (
                ...
                if (((o.font = f), p)) {
                  ...
                  r.each(t.legendItems, function (t, e) {
                    ...
                    w + M > m.height && ((_ += k + i.padding), x.push(k), (k = 0), (w = 0)),
                      (k = Math.max(k, n)),
                      (w += M),
            ...
            draw: function () {
              ...
              if (e.display) {
                ...
                r.each(t.legendItems, function (n, l) {
                  ...
                  x
                    ? S + M >= s &&
                      ((D = d.y += _), d.line++, (S = d.x = t.left + (s - u[d.line]) / 2))
                    : D + _ > t.bottom &&
                    ...
                    (function (t, i, n) {
                      if (!(isNaN(y) || y <= 0)) {
                        ...
                        if (
                          (h.setLineDash && h.setLineDash(c(n.lineDash, o.borderDash)),
              ...
              i = t.Scale.extend({
                ...
                handleTickRangeOptions: function () {
                  ...
                  ;(t.min = i(e.min, t.min)),
                    ...
                    null === t.max &&
                      (t.max = 0 !== t.min ? Math.pow(10, Math.floor(n.log10(t.min)) + 1) : 10),
                    null === t.minNotZero &&
                      (t.min > 0
                        ? (t.minNotZero = t.min)
                        : t.max < 1
                      ...
                      if (
                        (n.display &&
                          ...
                          (function (t, e, i, n) {
                            var r = t.ctx
                            if (
                              ((r.strokeStyle = a.valueAtIndexOrDefault(e.color, n - 1)),
                        ...
                        for (var p = o(t) - 1; p >= 0; p--) {
                          ...
                          if (l.display) {
                            ...
                            var x = t.getIndexAngle(p),
                              _ = a.toDegrees(x)
                            ;(i.textAlign =
                              0 === (f = _) || 180 === f ? 'center' : f < 180 ? 'left' : 'right'),
                              (d = _),
        ...
        function (t, e, i) {
              ...
              h =
                ...
                (function (t, e, i, n) {
                  ...
                  for (a = u.indexOf(t); a < d - 1; ++a)
                    if (
                      ((o = (r = l[u[a]]).steps ? r.steps[r.steps.length - 1] : s),
          ...
          e.exports = function (t) {
            var e = t.Scale.extend({
              ...
              getRightValue: function (e) {
                return (
                  e && void 0 !== e.t && (e = e.t), t.Scale.prototype.getRightValue.call(this, e)
                )
              },
              determineDataLimits: function () {
                var t,
                ...
                _.length &&
                  ((_ = h(_).sort(d)), (v = Math.min(v, _[0])), (y = Math.max(y, _[_.length - 1]))),
                  b.length &&
                    ((b = h(b).sort(d)),
                    (v = Math.min(v, b[0])),
              ...
              buildTicks: function () {
                ...
                for (
                  'ticks' === w.bounds && S.length && ((_ = S[0]), (k = S[S.length - 1])),
                    _ = g(M.min, x) || _,
                    k = g(M.max, x) || k,
                    t = 0,
                    e = S.length;
              ...
              getValueForPixel: function (t) {
                var e = this,
                  ...
                  r =
                    (i ? (t - a) / i : 0) * (e._offsets.left + 1 + e._offsets.left) -
                    e._offsets.right,
