!(function (t, e) {
  ...
  function At(t, e) {
    ...
    i &&
      ...
      !e.backdrop &&
        e.allowOutsideClick &&
        z('"allowOutsideClick" parameter requires `backdrop` parameter to be set to `true`'),
      (o = i),
      (n = e.position) in $
        ? gt(o, $[n])
        : (z('The "position" parameter is not valid, defaulting to "center"'), gt(o, $.center)),
      (n = i),
  ...
  function Ht(t, o) {
    ...
    r >= o.progressSteps.length &&
      ...
      o.progressSteps.forEach(function (t, e) {
        var n,
          t = ((n = t), (t = document.createElement('li')), gt(t, $['progress-step']), U(t, n), t)
        i.appendChild(t),
  ...
  var _t = function () {
    ...
    Qt = function (t, e) {
      ;(t.className = ''.concat($.popup, ' ').concat(bt(t) ? e.showClass.popup : '')),
        e.toast
          ? (gt([document.documentElement, document.body], $['toast-shown']), gt(t, $.toast))
          : gt(t, $.modal),
        F(t, e, 'popup'),
            ...
            e =
              ...
              function () {
                ...
                return p(
                  this,
                  o
                    ? ((t = u(this).constructor), Reflect.construct(e, arguments, t))
  ...
  var fe = function () {
    ...
    he = function (t) {
      ...
      return (
        ...
        (e === n || !(ct(n) || 'INPUT' === e.tagName || (ct(A()) && A().contains(e))))
      )
    },
    ...
    ke = function (t, e, n, o) {
      ;(oe.swalCloseEventFinishedCallback = ve.bind(null, t, n, X(), o)),
        e.addEventListener(Bt, function (t) {
          t.target === e &&
            (oe.swalCloseEventFinishedCallback(), delete oe.swalCloseEventFinishedCallback)
        })
    },
    xe = function (t, e) {
      setTimeout(function () {
  ...
  function Te(t) {
    var e = x()
    t.target === e && ((t = C()), e.removeEventListener(Bt, Te), (t.style.overflowY = 'auto'))
  }
  function Le(t, e) {
  ...
  var Ie = function (t, e) {
    ...
    je = function (t, e, n) {
      ...
      ;((/iPad|iPhone|iPod/.test(navigator.userAgent) && !window.MSStream) ||
        ...
        me(),
        fe()),
        'undefined' != typeof window && de() && (pe(), window.addEventListener('resize', pe)),
        e && 'hidden' !== n && le(),
        setTimeout(function () {
          t.scrollTop = 0
        })
        ...
        t.preConfirm
          ? (e.resetValidationMessage(),
            Promise.resolve()
              ...
              .then(function (t) {
                bt(S()) || !1 === t ? e.hideLoading() : Le(e, void 0 === t ? n : t)
              }))
          : Le(e, n)
    },
    ...
    Ge = function (t) {
      ...
      t.shiftKey ? De(0, o, -1) : De(0, o, 1), t.stopPropagation(), t.preventDefault()
    },
    tn = function (t) {
      ;-1 !== [T(), L(), I()].indexOf(document.activeElement) &&
        ((t = -1 !== Ze.indexOf(t) ? 'nextElementSibling' : 'previousElementSibling'),
    ...
    return new Promise(function (t) {
      ...
      ge.swalPromiseResolve.set(a, t),
        (s.confirmButton.onclick = function () {
          return (
            (e = c), (t = a).disableButtons(), void (e.input ? ze(t, e, 'confirm') : Ye(t, e, !0))
          )
          var t, e
        }),
  ...
  var dn = function (t, e, n) {
    ...
    pn = function (t, e) {
      if (!e.toast) return Y(e.allowEnterKey) ? void (fn(t, e) || De(0, -1, 1)) : mn()
    },
    fn = function (t, e) {
  ...
  function gn(t) {
    delete t.params, delete oe.keydownHandler, delete oe.keydownTarget, yn(St), yn(ge)
  }
  var vn,
    yn = function (t) {
